...
import getNewDealEmailContent from '../templates/newDeal';
...
const HANDLER_NAME = `sendNewDealEmail`;

const SENDER_EMAIL = 'noreply@info.ijuju.in';

// Function to send a new Deal email
async function sendNewDealEmail(request: Request) {
...
export default sendNewDealEmail;
