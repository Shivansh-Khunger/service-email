function getEmailContent(WEBSITE, SUPPORT_EMAIL, UNSUB_URL, GUIDLINES_URL, receiverName) {
	const welcomeEmailTemplate = `
        ...
        <body>
            ...
            <p>Have a great day ahead from Team iJUJU. For more information please visit our WEBSITE <a href="${WEBSITE}">iJUJU</a> or email us on <a href="mailto:${SUPPORT_EMAIL}">${SUPPORT_EMAIL}</a>. Your suggestions are always welcome.</p>
            <p>Thanks &amp; Regards,</p>
            <p>Team iJUJU,</p>
